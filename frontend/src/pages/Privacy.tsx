...
const SECTIONS: { h: string; p: string[] }[] = [
  { h: "1. Our approach", p: [
    "BharatTax is built for the Income-tax Department and tax professionals, where confidentiality of case data is paramount. We collect the minimum needed to run the Service, keep your data within your tenant, and never use content you upload to train shared models.",
  ]},
...
export default function Privacy() {
  return (
    <MarketingShell
      ...
      intro="How BharatTax collects, uses and protects your data — written for an audience that handles sensitive tax information."
    >
      ...
      <p className="mt-10 text-[13px] text-slate-500 border-t border-slate-200 pt-6">
        ...
        agreement with BharatTax or Wenvia, that agreement governs.
      </p>
    </MarketingShell>
  );
}
